...
VkRenderPass vulkanRenderPassManager :: renderPass;
...
void vulkanRenderPassManager :: initRenderPass() {
    ...
    auto renderPassReturn = vkCreateRenderPass(vulkanManager::device, &renderPassInfo, nullptr, &renderPass);
    if (renderPassReturn != VK_SUCCESS) {

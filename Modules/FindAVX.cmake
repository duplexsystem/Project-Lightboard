...
# Check AVX
if(MSVC AND NOT MSVC_VERSION LESS 1600 AND CMAKE_SIZEOF_VOID_P EQUAL 4)
...
# Check AVX2
if(MSVC AND NOT MSVC_VERSION LESS 1800 AND CMAKE_SIZEOF_VOID_P EQUAL 4)
...
if(HAVE_AVX2_EXTENSIONS)
    message(STATUS "Found AVX2 extensions, using flags: ${AVX_FLAGS}")
elseif(HAVE_AVX_EXTENSIONS)
    message(STATUS "Found AVX extensions, using flags: ${AVX_FLAGS}")
else()
